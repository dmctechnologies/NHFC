						...
						<tbody>
							<?php for ($i = 1; $row = $result->fetch(); $i++): ?>
								<tr>
									...
									<td><?= $row['date']; ?></td>
									<td>
										<a href="../event-detail.php?id=<?= $row['id']; ?>" target="_blank" class="btn btn-xs btn-primary">
											<i class="fa fa-eye"></i> View
										</a>
										<a href="deleteevent.php?id=<?= $row['id']; ?>" class="btn btn-xs btn-success warning_4 delbtn">
